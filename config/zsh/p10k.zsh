# Generated by Powerlevel10k configuration wizard on 2025-01-10 at 20:32 CST.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=87
  ...
  # Don't use terse signal names: "INT" instead of "SIGINT(2)".
  ...
  typeset -g POWERLEVEL9K_NIX_SHELL_BACKGROUND=87

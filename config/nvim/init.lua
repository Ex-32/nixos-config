...
-- conceal text into consise form
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>fs', builtin.builtin, { desc = '[F]ind Telescope [S]earch ' })
      ...
      vim.keymap.set('n', '<leader>/', function()
        -- You can pass aditional configuration to Telescope to change the theme, layout, etc.
